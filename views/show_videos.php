...
<meta property="og:title"  content="Impose Ta Connerie" /> 
    ...
    <div class="content_gauche">
        ...
        <div class="info_video">
            <h2><?php echo utf8_encode ($video[0]['titre']);?></h2>
            <p>Date: <?php echo $video[0]['date'];?></p>
            <p>Auteur: <?php echo $video[0]['auteur'];?></p>
        </div>

        <div class="videos">
            <a href="<?php echo $app->urlFor('videos') ?>"><img title="<?php echo $video[0]['nom_video'];?>" src="views/videos/video/<?php echo $video[0]['nom_video'];?>"/></a>
        </div>
