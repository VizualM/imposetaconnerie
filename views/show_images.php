...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
            ...
            <twitter><a href="http://twitter.com/share" class="twitter-share-button" data-text="<?php echo utf8_encode ($image[0]['titre']);?>" data-count="horizontal" data-via="Impose Ta Connerie">Tweet</a>
